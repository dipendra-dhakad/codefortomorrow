...
const Product = ({ post }) => {
  ...
  const imgUrl =
    "https://th.bing.com/th/id/OIP.xdkYsHta_MeHV_L6_i-Y4gAAAA?rs=1&pid=ImgDetMain";

  return (
    <div className="bg-gray-100 flex flex-col items-center justify-between relative  gap-2 p-1 mt-5 ml-5 rounded border ">
      <div>
